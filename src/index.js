...
export default class ReactCreditCards extends PureComponent {
  constructor(props) {
    super(props)
    ...
    return (
      <div key='Cards' className={rccs}>
        <div
          className={[
            rccsCard,
            getCardType(this.issuer),
            focused === 'cvc' && this.issuer !== 'amex' ? rccsCardFlipped : '',
          ].join(' ').trim()}
        >
          <div className={rccsCardFront}>
            <div className={rccsCardBackground} />
            <div className={rccsIssuer} />
            <div
              className={[
                rccsCvcFront,
                focused === 'cvc' ? rccsFocused : '',
              ].join(' ').trim()}
            >
              {cvc}
            </div>
            <div
              className={[
                rccsNumber,
                focused === 'number' ? rccsFocused : '',
                number.substr(0, 1) !== '•' ? rccsFilled : '',
              ].join(' ').trim()}
            >
              {number}
            </div>
            ...
            <div
              className={[
                rccsExpiry,
                focused === 'expiry' ? rccsFocused : '',
                expiry.substr(0, 1) !== '•' ? rccsFilled : '',
              ].join(' ').trim()}
            >
              <div className={rccsExpiryValid}>{locale.valid}</div>
              <div className={rccsExpiryValue}>{expiry}</div>
            </div>
            <div className={rccsChip} />
          </div>
          <div className={rccsCardBack}>
            <div className={rccsCardBackground} />
            <div className={rccsStripe} />
            <div className={rccsSignature} />
            <div
              className={[
                rccsCvc,
                focused === 'cvc' ? rccsFocused : '',
...
export const rccs = css`
  margin: 0 auto;
  perspective: 1000px;
  width: 290px;
`

export const rccsCardBackground = css`
  height: 200%;
  left: -170%;
  position: absolute;
  top: -60%;
...
export const rccsCard = css`
  ...
  width: 290px;
  & self:not(&--unknown) .${rccsCardBackground} {
    left: -22%;
  }
`

export const rccsIssuer = css`
...
export const rccsCardFront = css`
  backface-visibility: hidden;
  background: linear-gradient(25deg, #939393, #717171);
  border-radius: 14.5px;
  color: #fff;
...
export const rccsCardFlipped = css`
  transform: rotateY(180deg);
...
export const rccsExpiryValid = css`
  font-size: 10px;
  margin-bottom: 5px;
`

export const rccsExpiryValue = css`
  font-family: Consolas, Courier, monospace;
  font-size: 16px;
`

export const rccsName = css`
  bottom: 15%;
  font-family: Consolas, Courier, monospace;
  font-size: 17px;
  left: 10%;
...
export const rccsSignature = css`
...
export const rccsFilled = css`opacity: 0.8 !important;`

export const rccsFocused = css`
  font-weight: 700;
  opacity: 1 !important;
`
